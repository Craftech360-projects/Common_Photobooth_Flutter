                ...
                builder: (context, settings, child) {
                  return Column(
                      ...
                      children: [
                        ...
                        // NEW: Section for Swaplab Image Settings
                        _buildSectionTitle('Swaplab Image Settings'),
                        _buildSlider(
                          label: 'Swaplab Image Width',
                        ...
                        _buildSlider(
                          label: 'Swaplab Image Height',
                          value: settings.swaplabImageHeight,
                          min: 200.0,
                          max: 1200.0,
                          onChanged: (value) =>
                              settings.setSwaplabImageDimensions(
                                  settings.swaplabImageWidth, value),
                        ),

                        const Divider(),

                        _buildSectionTitle('Common Image Settings'),
                        _buildSlider(
                          label: 'Border Radius',
