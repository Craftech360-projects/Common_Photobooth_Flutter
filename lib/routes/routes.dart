...
import 'package:photobooth_flutter/presentation/admin/category_screen_settings.dart';
...
import 'package:photobooth_flutter/presentation/admin/theme_selection_settings.dart';
...
class AppRoutes {
  ...
  static const String categoryScreenSettings =
      '/admin/category_screen_settings';
  static const String themeSelectionSettings =
      '/admin/theme_selection_settings'; // FIX: Corrected route name
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case swappedFace:
        return MaterialPageRoute(
            builder: (_) => const SwappedFaceScreen(), settings: settings);
      ...
      case categoryScreenSettings:
        return MaterialPageRoute(
            builder: (_) => const CategoryScreenSettings());
      case themeSelectionSettings:
        return MaterialPageRoute(
            builder: (_) =>
                const ThemeSelectionSettingsScreen()); // FIX: Corrected route case
